...
//     const searchMovies = () => {
//         const endpoint = `${API_URL}search/movie?api_key=${API_KEY}&language=en-us&with_genres=${genreId}`
//         setSearchTerm(search)
//         console.log(setSearchTerm+" sdcd")
//         fetchMoviesByGenre(endpoint)
//         console.log(fetcMovieByGenre+" sd")
//     }

//     const loadMoreMovies = () => {
//         const genresEndpoint = `${API_URL}discover/movie?api_key=${API_KEY}&language=en-us&with_genres=${genreId}&page=${CurrentPage + 1}`;
//         const searchEndpoint = `${API_URL}search/movie?api_key=${API_KEY}&language=en-us&with_genres=${genreId}&query=${searchTerm}&page=${CurrentPage + 1}`
