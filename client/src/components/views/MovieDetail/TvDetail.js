...
import { useFetchMovies } from '../MovieDetail/Sections/hooks/useFetchTvSeries';
...
function LandingPage() {
    ...
    //     let endpoint= ''
    //     setLoading(true)
    //     endpoint= `https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&with_genres=27`;
    ...
    return (
        <div style={{ width: '100%', margin: '0' }}>
            ...
            <div style={{ width: '85%', margin: '1rem auto' }}>
                ...
                <Title level={2} > <font color="white">Latest TV SERIES</font> </Title>
                <hr />
